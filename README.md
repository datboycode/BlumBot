...
# 🔥🔥 BLUM UPDATE FIXED! 🔥🔥
1. Updated code to no longer freeze on sign-in.✅
...
## [Settings](https://github.com/datboycode/BlumBot/blob/main/.env-example/)
...
```shell
git clone https://github.com/datboycode/BlumBot
cd BlumBot
```
